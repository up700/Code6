...
def config():
    ...
    parser.add_argument('--lambda0', default=7.5, type=float,
    ...
    parser.add_argument(
        "--aug",
        action="store_true",
        help="Whether to use explicit augmentation data.",
    )

    parser.add_argument(
        "--alpha", default=0.0, type=float, help="orth"
    )

    parser.add_argument(
        "--beta1", default=0.1, type=float, help="entity"
    )

    parser.add_argument(
        "--beta2", default=0.1, type=float, help="context"
    )
